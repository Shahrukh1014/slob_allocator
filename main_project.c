#include<stdio.h>
int main() {
	int fragmentation[15],blocks[15],Process[15],i,j,blocknum,processnum,temp,lowest=10000,highest=0,ch; //choice
	static int bf[15],pf[15]; //just to check status whether memory block is filled or not
